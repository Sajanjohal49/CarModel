...
const slashMotion = {
  rest: {   opacity: 0,  x: -2,ease: "easeOut", duration: 0.2, type: "tween" },
  hover: {
    opacity: 1,
    x: 6,
...
const Button = () => {
  return (
    ...
    >
      <motion.h1 variants={textMotion}
      className='text-[10px] font-medium text-black lg:text-base'
      >Discover Now</motion.h1>
      <SlashContainer variants={slashMotion}>
      <AiOutlineArrowRight size='1.3rem' className=" text-slate-700  text-sm " />
